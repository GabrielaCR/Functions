...
from DATA_AGNfitter import DISTANCE, REDSHIFT, NAME
...
def stellar_info(chain, catalog, sourceline, path):

    stellar_templist= path+'models/GALAXY/input_template_hoggnew.dat'	    
   ...
   #constants
	...
	if tau<0.05:
		agelog_file, mstar_file, sfr_file = np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_const_ifort.4color', usecols=(0,6,9), skiprows=0, unpack= True)
	elif tau<0.2:
		agelog_file,  mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau01_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
	elif tau<0.45:
		agelog_file,  mstar_file, sfr_file = np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau03_ifort.4color', usecols=(0,6,9),skiprows=0, unpack= True)
	elif tau<0.8:
		agelog_file,  mstar_file, sfr_file = np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau06_ifort.4color', usecols=(0,6,9),skiprows=0, unpack= True)
	elif tau<1.5:
		agelog_file, mstar_file, sfr_file = np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau1_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
	elif tau<2.5:
		agelog_file, mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau2_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
	elif tau<4:
		agelog_file,  mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau3_ifort.4color', usecols=(0,6,9),skiprows=0, unpack= True)
	elif tau<7.5:
		agelog_file,  mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau5_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
	elif tau<12.5:
		agelog_file, mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau10_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
	elif tau<22.5:
		agelog_file,  mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau15_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
	else: 
		agelog_file, mstar_file, sfr_file= np.loadtxt(path+'models/GALAXYinfo/bc2003_lr_m62_chab_tau30_ifort.4color', usecols=(0,6,9), skiprows=0,unpack= True)
...
def stellar_info_best(best_fit_par, catalog, sourceline,  path):
   ...
   #constants
	...
	z = np.array([age_mcmc]) 
	nntau = NearestNeighbourSimple1D(y, tau_column , 1)
        nnage = NearestNeighbourSimple1D(z, age_column , 1)
